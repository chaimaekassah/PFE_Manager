...
import static org.pfemanager.model.Role.ADMINISTRATEUR;
...
public class AuthBean implements Serializable {
    ...
    public void login() throws IOException {
        ...
        User u = authService.authentifier(email.trim(), motDePasse);
        if (u == null) {
    ...
    public void register() throws IOException {
        ...
        if (roleSelectionne == null || roleSelectionne.trim().isEmpty()) {
            messageErreur = "Le rôle est obligatoire.";
            return;
        }
    ...
    public void setUtilisateurConnecte(User utilisateurConnecte) {
